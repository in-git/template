...
//		设置登陆路径
	...
	@Bean
	public com.zzsoftware.config.shiro.ShiroRealm getUserRealm() {
		return new com.zzsoftware.config.shiro.ShiroRealm();
	}
	...
	@Bean
	public SecurityManager securityManager(com.zzsoftware.config.shiro.ShiroRealm shiroRealm) {
